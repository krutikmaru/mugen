...
const GlowLevel1 = () => {
  return (
    <motion.div
      ...
      className="from-white dark:bg-mugen-purple-dark w-[780px] h-[780px] shadow-ball-level-1 rounded-full absolute top-0"
    ></motion.div>
  );
};
...
const GlowLevel2 = () => {
  return (
    <motion.div
      ...
      className="bg-white dark:bg-mugen-purple-dark w-[760px] h-[760px] shadow-ball-level-2 rounded-full absolute top-0"
    ></motion.div>
  );
};
