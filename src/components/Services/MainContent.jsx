...
const MainContent = ({ setIsMainContentVisible, mainContent }) => {
  ...
  return (
    ...
    >
      <div className="w-screen min-h-screen  bg-mugen-purple-dark flex justify-between flex-col items-center p-10 px-52">
        <FontAwesomeIcon
          icon={faX}
          className="absolute top-10 right-14 cursor-pointer z-[1000]"
          onClick={() => {
        ...
        <div className="w-full ">
          ...
          <div>
            <h1
              ...
              bg-clip-text font-semibold text-7xl pb-5"
            >
              {currentItem.title}
            </h1>
          </div>
          ...
          <div className="mt-2 text-2xl text-gray-300 ">
            ...
            <div className="flex flex-wrap mt-2">
              {currentItem.modules.map((module) => {
                return (
                  <span className="px-4 py-1 text-base rounded-full mr-2 mb-2 border-[1px] border-mugen-purple-white">
                    {module}
                  </span>
                );
              })}
            ...
            {mainContent.map((object) => {
              return (
                <div
                  ...
                  className="w-full h-full mb-5 p-5 mr-5 bg-[#9142ff] rounded-md overflow-hidden flex flex-col justify-center items-center cursor-pointer m-auto"
                >
